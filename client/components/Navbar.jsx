    ...
    <div className="nav-container">
      <div className="nav-bar py-1 bg-white border-bottom">
        ...
        <div className="nav-left">
          {isAuthenticated ? (
            <form onSubmit={handleSignOut} className="d-inline-block">
              <button type="submit" className="nav-link d-inline-block" style={{ border: 'none', padding: '5px', background: 'none' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="black" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
